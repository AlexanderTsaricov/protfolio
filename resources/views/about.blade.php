    ...
    <main class="main">
                ...
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    ...
                    <g clip-path="url(#clip0_26533_3705)">
                        <path d="M3.5 3.5H21.5C21.7652 3.5 22.0196 3.60536 22.2071 3.79289C22.3946 3.98043 22.5 4.23478 22.5
                            ...
                            5 16.743L11.743 12.5L7.5 8.257L6.086 9.672L8.914 12.5Z" fill="#62748E" />
                    </g>
                    <defs>
            ...
            <button class="leftMenu_button">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    ...
                    <g clip-path="url(#clip0_26533_3732)">
                        <path
                            d="M5.5 20.5H19.5V22.5H5.5V20.5ZM12.5 18.5C10.3783 18.5 8.34344 17.6571 6.84315 
            ...
            <button class="leftMenu_button">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                    ...
                    <g clip-path="url(#clip0_26533_3742)">
                        <path
                            d="M17.5 4.5C19.0913 4.5 20.6174 5.13214 21.7426 6.25736C22.8679 7.38258 23.5 8.9087 
        ...
        <div class="content">
            ...
            <div class="selectedContentBox">
                <div class="selectedSmallPage"></div>
                <div class="selectedSmallContent"></div>
            </div>
        </div>
    </main>
    @include('footer')
