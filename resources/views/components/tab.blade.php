<div class="tabBox unactive">
    <p class="tabBox_text" id="tab_{{ $tab->getId() }}">{{ $tab->getName() }}
    </p>
    <svg class="tabBox_close" id="tabClose_${tab}" width="10" height="10" viewBox="0 0 10 10" fill="none"
